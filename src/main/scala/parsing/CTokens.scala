...
// variables, pointers, functions, arrays...
...
sealed trait TypeSpecifierTyped extends TypeSpecifier

case class TypeSpecifierVoid() extends TypeSpecifierTyped
case class TypeSpecifierChar() extends TypeSpecifierTyped
case class TypeSpecifierShort() extends TypeSpecifierTyped
case class TypeSpecifierInt() extends TypeSpecifierTyped
case class TypeSpecifierLong() extends TypeSpecifierTyped
case class TypeSpecifierFloat() extends TypeSpecifierTyped
case class TypeSpecifierDouble() extends TypeSpecifierTyped
case class TypeSpecifierSigned() extends TypeSpecifierTyped
case class TypeSpecifierUnsigned() extends TypeSpecifierTyped
case class TypeSpecifierBool() extends TypeSpecifierTyped
case class TypeSpecifierComplex() extends TypeSpecifierTyped
...
// The full definition of a function, including body
case class FunctionDefinition(
                               // >>int<< main(...
                               spec: DeclarationSpecifiers,
                               // int >>main<<(...
                             // TODO
                               // or maybe int main(>>int argc<<) {... ??
                               dec: Declarator,
                               // maybe int main(>>int argc<<) {... ??
                               decs: Option[DeclarationList],
                               // int main(int argc) >> { ... } <<
                               v: CompoundStatement) extends ExternalDeclaration
...
case class ParameterDeclarationAbstractDeclarator(v: DeclarationSpecifiers, v2: AbstractDeclarator) extends ParameterDeclaration
...
// char myArray[]
// const char* myArray[]
case class DDArray(identifier: Identifier) extends DirectDeclarator

// >>someFunc(int arg1, char* arg2)<< {
case class FunctionDeclaration(
                                // >>someFunc<<(int arg1, char* arg2)
                                name: Identifier,
                                // someFunc(>>int arg1, char* arg2<<) {
                                params: ParameterTypeList) extends DirectDeclarator
